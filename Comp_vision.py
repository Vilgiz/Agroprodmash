...
class Vision():
    ...
    def __init__(self) -> None:
        ...
        self.brightness_factor = 0.923
        self.contrast_factor = 0.861
    ...
    def prediction(self, img, positions):
        i = 0
        for pt in positions:
            center = [pt[0], pt[1]]  # Извлекаем элемент из вложенного массива
    ...
    def find_qr_alt(self):
        ...
        center = self.track_only_coord[0]
        ...
        low_red = (0,0,0)                                       # ? Ползунки
        high_red = (200,200,200)                                # ? Ползунки
    ...
    def new_prediction(self, img, positions):
        ...
        for pt in positions:
            ...
            if i == 9:
                ...
                position = [positions[i+1][0], positions[i+1][1]]
...
if __name__ == '__main__':
    ...
    while True:
        ...
        Vis.sort()                               # ? сортируем
        #item = Vis.coord_transform              # ! Координаты
        ...
        if item is not None:
            if item != []: 
                ...
                if size == coord.size:
                    ...
                    coord.dequeue()
                    robot_tsp.send_step(0, Vis.pred[0], Vis.pred[1])